document.addEventListener('DOMContentLoaded', () => {
    ...
    // Renderizar descripción detallada con sistema expandible
    const repairDetailsList = document.getElementById('repair-details');
    repairDetailsList.innerHTML = '';

    product.description.forEach((section, index) => {
        const li = document.createElement('li');
        li.className = 'repair-section';

        // Crear el header clickeable
        const header = document.createElement('div');
        header.className = 'repair-section-header';
        header.innerHTML = `
        ...
        content.className = 'repair-section-content';
