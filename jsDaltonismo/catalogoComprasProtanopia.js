document.addEventListener('DOMContentLoaded', () => {
    // Base de datos de productos para protanopia
    const productsData = [
        { code: '00001', name: 'Juego Destornilladores', image: '../imagesDaltonismo/destornilladoresProtanopia.png', priceOld: 28.95, priceCurrent: 26.05 },
        { code: '00002', name: 'Martillo Bellota', image: '../imagesDaltonismo/martilloProtanopia.png', priceOld: 12.95, priceCurrent: 12.17 },
        { code: '00003', name: 'Alicates', image: '../imagesDaltonismo/alicatesProtanopia.png', priceOld: 14.93, priceCurrent: 12.39 },
        { code: '00004', name: 'Llave Inglesa', image: '../images/llave-inglesa.jpg', priceOld: 28.95, priceCurrent: 23.16 },
        { code: '00005', name: 'Cutter Profesional', image: '../imagesDaltonismo/cutterProtanopia.png', priceOld: 3.49, priceCurrent: 2.72 },
        { code: '00006', name: 'Juego de Llaves Allen', image: '../imagesDaltonismo/llavesProtanopia.png', priceOld: 10.49, priceCurrent: 9.12 }
    ];
    ...
    function renderProducts(products) {
      ...
      `;
            ...
            // Al hacer clic en la tarjeta, ir a la página de información del producto (protanopia)
            card.addEventListener('click', () => {
                window.location.href = `infoComprasProtanopia.html?code=${product.code}`;
            });
