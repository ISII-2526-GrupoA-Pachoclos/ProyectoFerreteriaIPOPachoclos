document.addEventListener('DOMContentLoaded', () => {
    // Base de datos de productos para reparación (tritanopia)
    const productsData = {
        '00001': {
            name: 'Juego Destornilladores',
            image: '../imagesDaltonismo/destornilladoresTritanopia.png',
            price: 5.45,
            days: '1-3 días',
            description: [
                {
        ...
        '00002': {
            ...
            image: '../imagesDaltonismo/martilloTritanopia.png',
            price: 9.75,
            days: '1-5 días',
            description: [
                {
        ...
        '00003': {
            name: 'Alicates',
            image: '../imagesDaltonismo/alicatesTritanopia.png',
            price: 11.89,
            days: '1-3 días',
            description: [
                {
        ...
        '00005': {
            ...
            image: '../imagesDaltonismo/cutterTritanopia.png',
            price: 2.95,
            days: '1-3 días',
            description: [
                {
        ...
        '00006': {
            ...
            image: '../imagesDaltonismo/llavesTritanopia.png',
            price: 8.69,
            days: '1-3 días',
            description: [
                {
    ...
    document.getElementById('btn-add-cart').addEventListener('click', () => {
        ...
        // Redirigir al carrito (versión tritanopia)
    ...
    if (logo) {
        logo.addEventListener('click', () => {
            window.location.href = 'indexTritanopia.html';
        });
