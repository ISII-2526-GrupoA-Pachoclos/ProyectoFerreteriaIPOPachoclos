document.addEventListener('DOMContentLoaded', () => {
    ...
    const productsData = [
        { code: '00001', name: 'Juego Destornilladores', manufacturer: 'Leroy Merlin', image: '../imagesDaltonismo/destornilladoresProtanopia.png', priceOriginal: 28.95, discount: 10 },
        { code: '00002', name: 'Martillo Bellota', manufacturer: '3M', image: '../imagesDaltonismo/martilloProtanopia.png', priceOriginal: 12.95, discount: 6 },
        { code: '00003', name: 'Alicates', manufacturer: '3M', image: '../imagesDaltonismo/alicatesProtanopia.png', priceOriginal: 14.93, discount: 17 },
        { code: '00004', name: 'Llave Inglesa', manufacturer: 'Cadena88', image: '../images/llave-inglesa.jpg', priceOriginal: 28.95, discount: 20 },
        { code: '00005', name: 'Cutter Profesional', manufacturer: 'Cadena88', image: '../imagesDaltonismo/cutterProtanopia.png', priceOriginal: 3.49, discount: 22 },
        { code: '00006', name: 'Juego de Llaves Allen', manufacturer: 'Leroy Merlin', image: '../imagesDaltonismo/llavesProtanopia.png', priceOriginal: 10.49, discount: 13 }
    ];

    let filteredProducts = [...productsData];

    // Navegación: logo → indexProtanopia
    ...
    function renderOffers(products) {
      ...
      `;
        ...
        // Botones ">" → ir a catalogoComprasProtanopia
