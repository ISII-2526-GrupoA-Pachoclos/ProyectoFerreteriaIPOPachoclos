document.addEventListener('DOMContentLoaded', () => {
    // Base de datos de productos para reparación - VERSIÓN PROTANOPIA
    const productsData = [
        { code: '00001', name: 'Juego Destornilladores', image: '../imagesDaltonismo/destornilladoresProtanopia.png', repairPrice: 5.45, days: '1 a 3 días' },
        { code: '00002', name: 'Martillo Bellota', image: '../imagesDaltonismo/martilloProtanopia.png', repairPrice: 9.75, days: '1 a 5 días' },
        { code: '00003', name: 'Alicates', image: '../imagesDaltonismo/alicatesProtanopia.png', repairPrice: 11.89, days: '1 a 3 días' },
        { code: '00004', name: 'Llave Inglesa', image: '../images/llave-inglesa.jpg', repairPrice: 14.37, days: '1 a 3 días' },
        { code: '00005', name: 'Cutter Profesional', image: '../imagesDaltonismo/cutterProtanopia.png', repairPrice: 2.95, days: '1 a 3 días' },
        { code: '00006', name: 'Juego de Llaves Allen', image: '../imagesDaltonismo/llavesProtanopia.png', repairPrice: 8.69, days: '1 a 3 días' }
    ];
    ...
    function renderProducts(products) {
      ...
      `;
            ...
            // Al hacer clic, ir a la página de información del producto (protanopia)
            card.addEventListener('click', () => {
                window.location.href = `infoReparacionProtanopia.html?code=${product.code}`;
            });
